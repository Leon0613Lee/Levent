...
<body>
  ...
  <div style="margin-bottom: 3%;margin-top: 0%;">
  <div class="header">
  ...
  <form method="POST" action="register.php">
  	...
  	<div class="input-group">
  	  ...
  	  <input type="text" name="userID" placeholder="chinwei99" >
  	</div>
  	<div class="input-group">
  	  <label>Fullname</label>
  	  <input type="text" name="fullname" placeholder="Foong Chin Wei">
  	</div>
    <div class="input-group">
      <label>Are you the president of society/club?</label>
      <select class="browser-default" name="president">
        <option value="0">NO</option>
        <option value="1">Yes</option>
      </select>
    </div>
    <div class="input-group">
      <label>Society/Club</label>
      <input type="text" name="society" placeholder="Department of Computer Science" >
      <label style="color: red;">*Society/club name required only for president</label>
    </div>
  	<div class="input-group">
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_user" style="background-color:#ffb300;">Register</button>
  	</div>
  	<p>
