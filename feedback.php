...
<div style="margin-top: 0%;">
  ...
  <form method="POST" action="fbserver.php" enctype="multipart/form-data">
  	<div class="input-group">
  		<textarea cols="50" rows="4" name="fb-comment" style="resize: 0%;" required></textarea>
  	<div class="input-group">
  		<button type="submit" class="btn" name="fb" style="background-color:#ffb300;">Submit</button>
  	</div>
  </form>
</div>
