...
$astatus='true';
$record=0;
$sql = "SELECT caid,causer,caname,cadate,cadate2,atime,atime2,cavenue,cacategory,cadescription,cacommittee,catime,status FROM event WHERE status='$astatus' ORDER BY caid DESC LIMIT 8";
...
if ($result->num_rows > 0) {
  ...
  echo "<p style='text-align: center; font-size: 30px;'>No activity.</p>";
  $record=1;
}
if($record==0){
  echo "<p style='text-align: center; font-size: 30px;'>No activity.</p>";
